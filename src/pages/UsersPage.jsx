...
export default function UsersPage({ defaultFilter = "users" }) {
  ...
  if (!isAdmin) {
    return (
      <PageLayuot pageTitle="مدیریت کاربران">
  ...
  const handleSetFilter = useCallback(
    ...
    [setActiveFilter, setSelectedUser]
  );
  ...
  const managementOptions = [
    {
      ...
      description: "فهرست تمام کاربران تحت نظارت شما را ببینید و برای هر نفر مشتریان و فاکتورهایش را بررسی کنید.",
      buttonLabel: "مشاهده کاربران",
      onClick: () => handleSetFilter("users"),
      type: "filter",
      filterKey: "users",
    ...
    },
    {
      ...
      description: "سوپر ادمین‌ها می‌توانند لیست ادمین‌های فعال را بررسی کرده و رفتار آن‌ها را کنترل کنند.",
      buttonLabel: "لیست ادمین‌ها",
      onClick: () => handleSetFilter("admins"),
      type: "filter",
      filterKey: "admins",
      roles: ["SUPER_ADMIN"],
    },
    ...
    },
    {
      ...
      onClick: () => scrollToSection(invoicesSectionRef),
      type: "section",
      roles: ["ADMIN", "SUPER_ADMIN"],
    },
  ];
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 p-6 space-y-4">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
            ...
            {isSuperAdmin && (
              <div className="inline-flex rounded-xl bg-gray-100/60 dark:bg-gray-900/60 p-1">
                {ROLE_TABS.map((tab) => (
                  <button
                    key={tab.key}
                    ...
                    className={`px-4 py-2 rounded-xl text-sm font-medium transition-colors ${
                      activeFilter === tab.key
                        ? "bg-white dark:bg-gray-800 text-teal-600"
          ...
          {selectedUser ? (
            <>
              ...
              >
                ...
                {invoiceLoading ? (
                  <div className="flex items-center justify-center min-h-[200px]">
                    <LoadingSpinner size={32} message="در حال بارگذاری فاکتورها ..." />
                  </div>
                ) : (
                  <InvoicesTable
